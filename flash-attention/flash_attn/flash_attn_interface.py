...
class FlashAttnQKVPackedFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        if rng_state is None or (isinstance(rng_state, torch.Tensor) and rng_state.numel() == 0):
            # allocate a dummy [seed, offset]
    ...
    def backward(ctx, dout, *args):
        import sys; sys.stderr.write("[PY VARLEN BACKWARD]\n")
